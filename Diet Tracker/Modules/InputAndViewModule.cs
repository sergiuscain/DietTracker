...
internal class InputAndViewModule
{
    ...
    private void EditGoalsMenu()
    {
        Console.Write($"\t═══════════════════════════════════════\n");
        Console.Write($"\t═══ Введите цель по калориям ══════════\n");
        Console.Write($"\t═══════════════════════════════════════\n\t");
        var caloriesInput = GetInputRangeKey(9999);
        var goals = new Goals { Calories = caloriesInput };
        _storageModule.EditGoals(goals);
    }
